...
// and drives the matching trash MIRROR through the SAME fixed-delay snapshot interp the per-slot
...
// host stops streaming, and ClearDriveForEid ends the carry at the landing.
//
