...
// proximity; this records the answer directly for the writer whose geometry proves nothing -- a
// broom stroke the host runs, its own or a client's, whose pile may die beside that client anywhere
// in the world. Consumed by the next death of that key, expires in seconds. Game thread.
