...
//
// BOTH ARE DELIBERATELY LEAKED. A GcPin can live inside another static (trash_mirror's map of the
// mirrors it made, engine_audio's permanent pins), so a Release() can run during static
// destruction at DLL unload,
